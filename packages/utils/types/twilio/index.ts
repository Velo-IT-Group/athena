...
export const voicemailAttributesSchema = z.object({
    from_country: z.string(),
    called: z.string(),
    ...
    conversations: z.object({
        hang_up_by: z.string(),
        abandoned_phase: z.string(),
        abandoned: z.string(),
        segment_link: z.string(),
        in_business_hours: z.string(),
    }),
    to_state: z.string(),
    worker_sid: z.string(),
    taskType: z.literal("voicemail"),
    caller_country: z.string(),
    userLastName: z.string(),
    account_sid: z.string(),
    from_zip: z.string(),
    ...
    callBackData: z.object({
        ...
        isDeleted: z.boolean(),
        numberToCallFrom: z.string(),
        taskSid: z.string(),
        recordingUrl: z.string(),
        attempts: z.number(),
        mainTimeZone: z.string(),
        utcDateTimeReceived: z.string(),
    }),
    direction: z.string(),
    channelSid: z.string(),
    called_zip: z.string(),
