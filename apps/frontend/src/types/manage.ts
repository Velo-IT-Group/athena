...
const referenceCreationSchema = z.object({
	id: z.number(),
});
...
export const workflowSchema = z.object({
	...
	activateFlag: z.boolean(),
	batchInterval: z.number(),
	batchFrequencyUnit: z.string(),
	batchLastRan: z.string(),
...
export const scheduleEntrySchema = z.object({
	...
	doneFlag: z.boolean(),
	acknowledgedFlag: z.boolean(),
	ownerFlag: z.boolean(),
	meetingFlag: z.boolean(),
	allowScheduleConflictsFlag: z.boolean(),
	addMemberToProjectFlag: z.boolean(),
	projectRoleId: z.number(),
	mobileGuid: z.string(),
	acknowledgedDate: z.string(),
	closeDate: z.string(),
	notifyResource: z.boolean(),
	notificationSent: z.boolean(),
	notificationResponse: z.string(),
	hours: z.number(),
	startTimeSet: z.boolean(),
	endTimeSet: z.boolean(),
	_info: z.object({
		additionalProp1: z.string(),
		additionalProp2: z.string(),
		additionalProp3: z.string(),
...
export const convertOpportunityToProjectSchema = z.object({
	...
	status: referenceCreationSchema.optional(),
	locationId: z.number().optional(),
	businessUnitId: z.number().optional(),
	board: referenceCreationSchema,
	manager: referenceCreationSchema.optional(),
	estimatedStart: z.string(),
	estimatedEnd: z.string(),
	includeAllNotesFlag: z.boolean().optional(),
	includeAllDocumentsFlag: z.boolean().optional(),
	includeAllProductsFlag: z.boolean().optional(),
	includeNoteIds: z.array(z.number()).optional(),
	includeDocumentIds: z.array(z.number()).optional(),
	includeProductIds: z.array(z.number()).optional(),
});

export const createProductSchema = z.object({
	catalogItem: referenceCreationSchema,
	description: z.string().optional(),
	sequenceNumber: z.number().optional(),
	quantity: z.number().optional(),
	unitOfMeasure: referenceCreationSchema.optional(),
	price: z.number().optional(),
	cost: z.number().optional(),
	extPrice: z.number().optional(),
	extCost: z.number().optional(),
	discount: z.number().optional(),
	margin: z.number().optional(),
	agreementAmount: z.number().optional(),
	priceMethod: z.string().optional(),
	billableOption: z.enum(["Billable", "DoNotBill", "NoCharge"]),
	agreement: referenceCreationSchema.optional(),
	locationId: z.number().optional(),
	location: referenceCreationSchema.optional(),
	businessUnitId: z.number().optional(),
	businessUnit: referenceCreationSchema.optional(),
	vendor: referenceCreationSchema.optional(),
	...
	cancelledFlag: z.boolean().optional(),
	quantityCancelled: z.number().optional(),
	cancelledReason: z.string().optional(),
	customerDescription: z.string().optional(),
	internalNotes: z.string().optional(),
	productSuppliedFlag: z.boolean().optional(),
	subContractorShipToId: z.number().optional(),
	subContractorAmountLimit: z.number().optional(),
	recurring: referenceCreationSchema.optional(),
	sla: referenceCreationSchema.optional(),
	entityType: referenceCreationSchema.optional(),
	ticket: referenceCreationSchema.optional(),
	project: referenceCreationSchema.optional(),
	phase: referenceCreationSchema.optional(),
	salesOrder: referenceCreationSchema.optional(),
	opportunity: referenceCreationSchema.optional(),
	invoice: referenceCreationSchema.optional(),
	warehouseId: z.number().optional(),
	warehouseIdObject: referenceCreationSchema.optional(),
	warehouseBinId: z.number().optional(),
	warehouseBinIdObject: referenceCreationSchema.optional(),
	calculatedPriceFlag: z.boolean().optional(),
	calculatedCostFlag: z.boolean().optional(),
	...
	taxCode: referenceCreationSchema.optional(),
	integrationXRef: z.string().optional(),
	listPrice: z.number().optional(),
	serialNumberIds: z.array(z.number()).optional(),
	serialNumbers: z.array(z.string()).optional(),
	company: referenceCreationSchema.optional(),
	forecastStatus: referenceCreationSchema.optional(),
	productClass: z.string().optional(),
	needToPurchaseFlag: z.boolean().optional(),
	needToOrderQuantity: z.number().optional(),
	minimumStockFlag: z.boolean().optional(),
	shipSet: z.string().optional(),
	calculatedPrice: z.number().optional(),
	calculatedCost: z.number().optional(),
	invoiceGrouping: referenceCreationSchema.optional(),
	poApprovedFlag: z.boolean().optional(),
	uom: z.string().optional(),
	addComponentsFlag: z.boolean().optional(),
	ignorePricingSchedulesFlag: z.boolean().optional(),
	asioSubscriptionsID: referenceCreationSchema.optional(),
	bypassForecastUpdate: z.boolean().optional(),
});

export const createOpportunitySchema = z.object({
	name: z.string(),
	expectedCloseDate: z.string().optional(),
	type: referenceCreationSchema,
	stage: referenceCreationSchema.optional(),
	status: referenceCreationSchema.optional(),
	priority: referenceCreationSchema.optional(),
	probability: referenceCreationSchema.optional(),
	rating: referenceCreationSchema.optional(),
	primarySalesRep: referenceCreationSchema,
	notes: z.string().optional(),
	source: z.string().optional(),
	campaign: referenceCreationSchema.optional(),
	secondarySalesRep: referenceCreationSchema.optional(),
	locationId: z.number().optional(),
	businessUnitId: z.number().optional(),
	company: referenceCreationSchema.optional(),
	contact: referenceCreationSchema,
	site: referenceCreationSchema.optional(),
	customerPO: z.string().optional(),
	pipelineChangeDate: z.string().optional(),
	dateBecameLead: z.string().optional(),
	closedDate: z.string().optional(),
	closedBy: referenceCreationSchema.optional(),
	totalSalesTax: z.number().optional(),
	shipToCompany: referenceCreationSchema.optional(),
	shipToContact: referenceCreationSchema.optional(),
	shipToSite: referenceCreationSchema.optional(),
	billToCompany: referenceCreationSchema.optional(),
	billToContact: referenceCreationSchema.optional(),
	billToSite: referenceCreationSchema.optional(),
	billingTerms: referenceCreationSchema.optional(),
	taxCode: referenceCreationSchema.optional(),
	currency: referenceCreationSchema.optional(),
	companyLocationId: z.number().optional(),
	technicalContact: referenceCreationSchema.optional(),
});
