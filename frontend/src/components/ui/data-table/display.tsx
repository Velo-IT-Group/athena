...
const DataTableDisplay = <TData extends { id: string }, TValue>({ table, columns }: Props<TData, TValue>) => {
	...
	return (
		<div className='rounded-md border'>
			...
			<div className='absolute top-3 right-1/2 -translate-x-1/2 bg-background rounded-full min-w-fit flex items-center gap-1.5 border shadow-xs dark:bg-input/30 dark:border-input'>
				<Button
					variant='ghost'
					size='sm'
				>
