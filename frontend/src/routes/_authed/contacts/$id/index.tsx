				...
				>
					...
					>
						...
						>
							...
							>
								<div
									className='sc-fVZHzn gofSGJ'
									style={{
										boxSizing: 'border-box',
										gap: '8px',
										display: 'grid',
										gridTemplateColumns:
											'repeat(\n        auto-fill,\n        minmax(max(168px, calc((100% - calc(calc(3 - 1) * 8px)) / 3)), 1fr)\n    )',
									}}
								>
									<div
										className='sc-dHeBBl ACfd'
										style={{
											boxSizing: 'border-box',
											position: 'relative',
											height: '86px',
									...
									>
										...
										>
											...
											>
												<div
													className='sc-bXdtCk fzMogh sc-gAgoYo FleJj'
													style={{
														boxSizing: 'border-box',
														gap: '8px',
														display: 'flex',
														...
														justifyContent:
															'space-between',
														paddingInline:
															'var(--widget-padding-x, 12px)',
														paddingTop:
															'var(--widget-padding-y, 10px)',
													}}
												>
													<div
														className='sc-hoLldG itPSss sc-cIozSW bZFlVj'
														style={{
															boxSizing:
																'border-box',
															fontStyle: 'normal',
													...
													>
														<use
															height='14px'
															width='14px'
															href='https://app.attio.com/web-assets/assets/icon-defs/142902a299140d818fd66c4324971755.svg#icon'
															style={{
																boxSizing:
																	'border-box',
															}}
												...
												>
													<div
														className='sc-bXdtCk fZuFoQ sc-cRNklu jihniQ'
														style={{
															boxSizing:
																'border-box',
															gap: '4px',
													...
													>
														<div
															className='sc-bXdtCk bAcKFT sc-iWTvZg epJmOl'
															style={{
																boxSizing:
																	'border-box',
																gap: '0px',
												...
												>
													...
													>
														<use
															height='14px'
															width='14px'
															href='https://app.attio.com/web-assets/assets/icon-defs/2c454537dc9591b4b4d06f1f5dcea548.svg#icon'
															style={{
																boxSizing:
																	'border-box',
															}}
									...
									>
										<div
											...
											style={{
												...
												position: 'absolute',
												boxShadow:
													'rgba(35, 37, 41, 0.06) 0px 0px 0px 1px inset',
											}}
										>
											<div
												className='sc-hOygC bsNLHg'
												...
												>
													...
													>
														<use
															height='14px'
															width='14px'
															href='https://app.attio.com/web-assets/assets/icon-defs/3a70b32500ba408108f29ed2053958cf.svg#icon'
															style={{
																boxSizing:
																	'border-box',
															}}
												...
												>
													...
													>
														<use
															height='14px'
															width='14px'
															href='https://app.attio.com/web-assets/assets/icon-defs/f02efaa6e040be04aecabd64c517b500.svg#icon'
															style={{
																boxSizing:
																	'border-box',
															}}
												...
												>
													...
													>
														<use
															height='14px'
															width='14px'
															href='https://app.attio.com/web-assets/assets/icon-defs/03617041cf5793345c3e4b8ee35b2017.svg#icon'
															style={{
																boxSizing:
																	'border-box',
															}}
